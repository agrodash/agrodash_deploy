# Generated by Django 6.0.1 on 2026-01-12 03:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('senha_gerada', models.CharField(blank=True, max_length=128, verbose_name='Senha Gerada')),
                ('data_criacao', models.DateTimeField(auto_now_add=True, verbose_name='Data de Criação')),
                ('utilizado', models.BooleanField(default=False, verbose_name='Utilizado')),
                ('usuario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tokens_inscricao', to=settings.AUTH_USER_MODEL, verbose_name='Usuário')),
            ],
            options={
